...
#' year 2006-2016.
#' Data have been modified in order to have consistent net migration,
#' i.e. in the country the total number of cancellations equals
#' the total number of enrollement.
#'
#' @format An array with dimensions "age", "sex", "region" and "year".
#' Age groups are "0-17", "18-39", "40-64", "65+".
#'
